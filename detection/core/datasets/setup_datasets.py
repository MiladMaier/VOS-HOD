...
def setup_coco_ood_temp_dataset():
    test_image_dir = r"C:\Users\anna_\OneDrive\Dokumente\Object Detection\TEMP_COCO\val2017"
    test_json_annotations = r"C:\Users\anna_\OneDrive\Dokumente\Object Detection\TEMP_COCO\annotations\instances_val2017_ood_rm_overlap.json"
    ...
    register_coco_instances(
        ...
        test_image_dir)
    MetadataCatalog.get(
        "coco_ood_val_temp").thing_classes = metadata.COCO_THING_CLASSES
    MetadataCatalog.get(
        "coco_ood_val_temp").thing_dataset_id_to_contiguous_id = metadata.COCO_THING_DATASET_ID_TO_CONTIGUOUS_ID
